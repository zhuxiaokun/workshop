#ifndef __PCID_DISKID_H__
#define __PCID_DISKID_H__
...
//DriverInfo
enum {DriveType, DriveSerialNumber, DriveModelNumber, DriveControllerRevisionNumber, DriveControllerBufferSize, DriveSize};
