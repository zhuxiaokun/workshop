...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
   ...
   // firstViewController *vc=[[firstViewController alloc]initWithNibName:@"firstView" bundle:nil];
    ...
    if([[NSUserDefaults standardUserDefaults]boolForKey:@"firstLaunch"]){
        StarUpViewController *starview=[[StarUpViewController alloc]init];
        self.window.rootViewController=starview;
    ...
    }else
    {
     ...
     [NSThread sleepForTimeInterval:STARTUP_TIME];
